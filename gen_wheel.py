...
parser.add_argument("--height", "-g", type=float, dest="g_height", default=0.05,
...
parser.add_argument("--amp", "-a", type=float, dest="g_amp", default=0.00,
...
parser.add_argument("--tri_count", "-u", type=int, dest="tri_count", default=100,
